<div class="flex flex-col flex-shrink-0 w-48 h-full border-r border-gray-200 xl:w-80 dark:border-gray-800 ">
  ...
  <div class="p-5 border-b bg-gray-50 border-primary-800">
    ...
    <div class="flex my-3">
      <div class="flex items-center mr-3">
        ...
        <label for="inline-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Realiz.</label>
      </div>
      <div class="flex items-center mr-3">
        <input id="inline-2-radio" type="radio" value="2" wire:model="checkedStage" wire:click="saveNewStage"
          name="inline-radio-group"
          class="w-4 h-4 bg-gray-100 border-gray-300 text-primary-600 focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
        <label for="inline-2-radio" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Przygot.</label>
      </div>
      <div class="flex items-center mr-3">
  ...
  <div class="p-5 text-xs tracking-wider text-gray-400 flex items-center justify-between">
    ...
    <button class="text-xl text-primary-600 {{ $sort == 'desc' ? 'block' : 'hidden' }}" wire:click="switchSort('asc')">
      <i class="ph-sort-ascending-bold"></i>
    </button>

    <button class="text-xl text-primary-600 {{ $sort == 'asc' ? 'block' : 'hidden' }}" wire:click="switchSort('desc')">
      ...
      <div class="hidden">
        <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
          ...
          <div class="flex items-center w-full">
            <div class="px-2 py-1 text-xs leading-none rounded-md dark:bg-gray-900 bg-primary-100 text-primary-500">
              Design</div>
        ...
        <button
          ...
          <div class="flex items-center w-full">
            <div class="px-2 py-1 text-xs leading-none text-green-600 bg-green-100 rounded-md dark:bg-gray-900">
              Sales</div>
        ...
        <button class="flex flex-col w-full p-3 bg-white rounded-md shadow dark:bg-gray-800">
          ...
          <div class="flex items-center w-full">
            <div class="px-2 py-1 text-xs leading-none text-yellow-600 bg-yellow-100 rounded-md dark:bg-gray-900">
              Marketing</div>
