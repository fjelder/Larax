<div class="h-10 flex w-full border-b border-gray-200 dark:border-gray-800 shrink-0 box-content px-6">
    ...
    <div class="flex h-full text-gray-600 dark:text-gray-400 items-stretch">
        ...
        <a href="#"
            class="cursor-pointer h-full border-b-2 border-primary-500 text-primary-500 dark:text-white dark:border-white inline-flex mr-8 items-center">Users</a>
        <a href="#"
    ...
    <div class="ml-auto flex items-center space-x-7">
        <button class="h-8 px-3 rounded-md shadow text-white bg-primary-500">Deposit</button>
