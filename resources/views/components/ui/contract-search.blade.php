<form>
    <div class="flex shadow">
        ...
        <button id="dropdown-button" data-dropdown-toggle="dropdown"
            class="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-neutral-900 bg-neutral-50 border border-neutral-300 rounded-l-none hover:bg-neutral-200 focus:ring-4 focus:outline-none focus:ring-neutral-100 dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:focus:ring-neutral-700 dark:text-white dark:border-neutral-600"
        ...
        <div id="dropdown"
            class="hidden z-10 w-44 bg-white rounded divide-y divide-neutral-100 shadow dark:bg-neutral-600"
