<x-app-layout>
  ...
  <div class="py-10 mx-auto max-w-7xl sm:px-6 lg:px-8 flex flex-col md:flex-row flex-wrap items-start">
    ...
    <div class="content flex-1 ml-6 shadow-lg border dark:border-neutral-600 dark:text-neutral-300 text-neutral-700">

      @foreach($contracts as $contract)
      <a href="{{route('contracts.show', $contract->id)}}">
        <div
          class="bg-transparent border border-x-0 my-2 hover:bg-neutral-200 py-2 px-6 text-sm flex space-x-4 items-center dark:border-primary-700/30 hover:dark:bg-neutral-600 border-b-2">
          <div
